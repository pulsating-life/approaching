...
export default function (WrappedComponent) {
    return class XlsTempFile extends WrappedComponent {
        constructor(props) {
            super(props);

            this.state.__actionName = '';
            this.state.__upUrl = '';
        ...
        downXlsTempFile2 = (cols, data, obj) => {
            var self = this;
            ...
            for (var x = 1; x < count; x++) {
                ...
                var xlsData = JSON.stringify(data1);
            }*/
        ...
        uploadXlsFile = (url, data, cols, file, callback) => {
            var self = this;
