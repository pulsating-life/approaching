...
class ResetPasswdPage extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.userName) {
            var passwd = { username: this.props.userName, newEmail: "", newPasswd: "", confirmPad: "" };
            this.setState({ resetPasswd: passwd });
        }
    }
    ...
    clickRequestPwd = (event) => {
        ...
        if (!loginData.username) {
            loginData.username = this.state.resetPasswd.username;
        }
