...
class ModPasswdPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            passwd: {
    ...
    handleOnChange = (e) => {
        ...
        Common.validator(this, passwd, e.target.id);
        this.setState({
            passwd: passwd
        });
    }

    clickUpdatePwd = (event) => {
        this.state.errMsg = '';
        if (!Common.formValidator(this, this.state.passwd)) {
            return;
        }
