...
@ModalForm('fntApp')
class UpdateFntAppPage extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			fntAppSet: {},
	        ...
	        >
	       		<Form layout={layout}>
                    ...
                    <FormItem {...formItemLayout} label="服务说明" colon={true} className={layoutItem} help={hints.appDescHint} validateStatus={hints.appDescStatus}>
                        <TextArea name="appDesc" id="appDesc" value={this.state.fntApp.appDesc} onChange={this.handleOnChange} style={{ height: '80px' }} />
                    </FormItem>
	        	</Form>
	        </Modal>
	    );
