...
class SelectFuncPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            txnSet: {
    ...
    // 第一次加载
    componentDidMount() {
        this.unsubscribe = FuncTxnStore.listen(this.onServiceComplete);
        this.unsubscribe2 = TxnTreeStore.listen(this.onLoadTxnComplete);
    }
