...
class CreateAppInfoPage extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
            appInfoSet: {
    ...
    // 第一次加载
	componentDidMount() {
		this.unsubscribe = AppStore.listen(this.onAppComplete);
		this.unsubscribe2 = AppGroupStore.listen(this.onGroupComplete);
